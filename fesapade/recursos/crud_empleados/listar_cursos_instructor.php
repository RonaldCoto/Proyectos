...
//preparando consulta que traera los datos del curso a editar
  $registros=$con->prepare("SELECT cur.nombre as nombrecurso, cur.portada , emp.nombre as nombreempleado , fed.nombre as nombrefederado, fed.apellido as apellidofederado FROM matriculas as matri
