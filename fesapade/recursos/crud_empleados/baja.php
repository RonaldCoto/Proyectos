...
$response -> mensaje = 'Este empleado no puede ser eliminado ya que esta asignado a un curso.
Sin embargo puede cabiar el estado del perfil a "BAJA" en "Administrar Empleados" para que deje de ser accesible.';
header('Content-Type: application/json');
echo json_encode($response);
    }
?>